...
insert into skills (id,stat_id,info) values ('Interview','CHAR','The skill of eliciting interesting anecdotes from interview subject. This information will be of a more non-specific and personal nature rather than specific knowledge (distinguishing this skill from the skill Interrogation, where the user is trying to extract exact information. (Example: Barbara Walters interviews, Mike Wallace interrogates). At +3 or better, the subject will usually tell you only information relating to what he/she is well known for. At +6 or better, the subject will tell you anecdotes about the past, pontificate about favorite interests and philosophies, etc. At +9 or better, he/she tells you everything - including personal information about their illegitimate son, the time they stole a cookie at age +4, and the fact that no one ever loved them.');
insert into skills (id,stat_id,info) values ('Leadership','CHAR','The skill of leading and convincing people to follow you. A leader with a skill +2 can manage a small office successfully and be respected for it. A leader with skill +4 or better can lead a small band of troops into battle and not get backshot. A leader with a skill of +7 or better can lead entire Gamelon Empire into battle and look good doing it. James Kirk of Star Trek has a Leadership of +11, but you never will.');
insert into skills (id,stat_id,info) values ('Seduction','CHAR','The skill of forming and maintaining romantic relationships (this includes your abilities as a lover). This skill may be used to determine whether or not players can form relationships with other non-players characters and the intensity of these relationships. In certain cases, Referees may want to average this skill with a player''s Attractiveness to get a more realistic outcome.');
insert into skills (id,stat_id,info) values ('Bluff','CHAR',null);
insert into skills (id,stat_id,info) values ('Social','CHAR','The ability to deal with social situations, like knowing the right fork to use or when not to tell the joke about farmer''s daughter and the travelling cyberware salesman. A Social skill of +2 or better will allow you to get by at any fine restaurant or social function. At +5, you can lunch with the President with aplomb. No social situation will faze you , no matter what. At +8 or above, you can lecture Emily Post on what''s proper.');
insert into skills (id,stat_id,info) values ('Persuasion & Fast Talk','CHAR','The ability to talk others into doing what you want. This may be used individually or on large groups. At +3, you can win most debates or convince your girlfriend the blonde you were was your sister. At +5, you are a smooth talker of professional caliber. Ronald Reagan a Persuasion of +7. Hitler a Persuasion of +9.');
insert into skills (id,stat_id,info) values ('Human Perception','CHAR','The skill of detecting any evasions, moods and other emotional clues from others. At +2, you can usually feel when you''re not getting the whole truth. At +6, you can detect subtle evasions and mood swings. At +8, you can not only detect subtle emotional clues, but can usually tell what the subject is hiding in a general way.');
insert into skills (id,stat_id,info) values ('Perform','CHAR','The skill of trained acting, singing, etc. A trained performer of +4 or greater can successfully sing for payment at wedding or small clubs. Performers of +6 or greater will be considered to be of professional caliber, and may have lucrative contacts and fans. Performers of +9 or greater are of "star: caliber, have a large number of fans, and may be recognized on the street.');

insert into skills (id,stat_id,info) values ('Endurance','BODY','This is the ability to withstand pain or hardship, particularly over long periods of time, by knowing the best ways to conserve strength and energy. Endurance Skill checks would be made whenever a character must continue to be active a long period without food, sleep or water.');
insert into skills (id,stat_id,info) values ('Strength Feat','BODY','The user of this skill has practiced the art of bending bars, crushing objects, ripping phone books apart and other useful parlor tricks. At +3, no phonebook is safe, you can bend thin rebar, and snap handcuffs. At +10, you can bend prison bars, rip up the Gutenberg Bible, and dept car fenders with one blow.');
insert into skills (id,stat_id,info) values ('Swimming','BODY','This skill is require to know how to swim.');
insert into skills (id,stat_id,info) values ('Athletics','BODY','This skill is required for accurate throwing, climbing, and balancing. It combines the basic elements of any high school level sports program. At +3 and above, you are the equivalent of a real high school "jock". At +5 and above, you can perform in college level competitions. At +8 and above, you are of Olympic or Professional caliber.');

insert into skills (id,stat_id,info) values ('Intimidate','COOL','The skill of getting people to do what you want by forcing personality or physical coercion. At +3, you can frighten almost any typical citizen, politician or low-level thug. At +6, you can intimidate Sylvester Stallone or any moderate "tough guy". At +9, you could intimidate Arnold Schwarzenegger.');
insert into skills (id,stat_id,info) values ('Oratory','COOL','The skill of public speaking. At +2, you can wing high school contests. At +6, you can be paid speech in public. At +10, you are capable of delivering a speech to rival Kennedy''s "Ichn Bin Ein Berliner" or Lincoln''s Gettysburgs Address.');
insert into skills (id,stat_id,info) values ('Resist Torture/Drugs','COOL','Characters with this skill are especially toughened against interrogation, torture and mind control drugs. A successful use of this skill will automatically increase the difficulty of any Interrogation attempt made by another guy by one level.');
insert into skills (id,stat_id,info) values ('Streetwise','COOL','The knowledge of the "seamy" ways of life - where to get illegal and contraband things, how to talk to the criminal environment, and avoiding bad situations in bad neighborhoods. With Streetwise of +3 or better, you can get "hot" items, torture drugs, etc. A Streetwise of +5 would know you to arrange a murder contract, you know a few mobsters who might owe you, and be able to call on muscle when you need it. At +8 or better, you could become a major crimelord yourself and the middlemen.');

insert into skills (id,stat_id,info) values ('Chemistry','INT','The required skill for mixing chemicals various compounds. A level +2 Chemistry is equal to high school chemistry. A level +4 is equal to a trained pharmacist or college level chemist. A +8 is a trained laboratory chemist.');
insert into skills (id,stat_id,info) values ('Composition','INT','The required for writing songs, articles, or stories. A Composition Skill of +4 or greater gives your character the ability to produce salable work. A Skill of +8 or more produces work of such a high caliber that the creator may have a strong literary following and not a little critical acclaim.');
insert into skills (id,stat_id,info) values ('Gamble','INT','The skill on knowing how to make bets, figure odds, and play games of chance successfully. As any professional gambler knows, this is not a luck skill. At +2, you are the local card shark at the Saturday night poker game. At +6, you can make a living at the tables in Vegas and Monte Carlo. At +9 or better, you can take on James Bond at roulette and stand a good chance of breaking the bank.');
insert into skills (id,stat_id,info) values ('Database Search','INT','The skill of using databases, libraries and other compiled information sources to find facts. With a skill of +2 you can use most simple databases. With a skill of +6, you can easily access the Library Congress. At +9, you can comprehend almost any public databases and find very obscure facts.');
insert into skills (id,stat_id,info) values ('Mathematics','INT','The skill of understanding calculations and mathematical formulas. At +3, you have ability to add, subtract, divide and multiply. At +4, you can do algebra and geometry. At +6, you can perform calculus. At +9, you can deduce your own mathematical formulas.');
insert into skills (id,stat_id,info) values ('Physics','INT','The ability to calculate physical principles, such as gas pressures, mechanical energies, etc. This skill required basic Mathematics skill of +4.');
insert into skills (id,stat_id,info) values ('Programming','INT','The required skill to write programs and re-program computer system. This skill does not allow players to actually do repairs on a computer (this requires Electronics). With a Programming Skill of +1, you can do simple EBASIC programs. A Programming Skill of +3 or better allows you to know some higher level languages and he able to write reasonably complex programs (including video games). Players with Programming Skill +6 or better are considered to be professionals, who can build operating software, design mainframe systems, and hold down a steady job at your average Silicon Valley firm. With a Programming Skill of +9 or better, other programmers speak your name with reverence ("You invented Q? Wow!"), young hackers set soft to crack your systems, and any computer software you design instantly gets used by every business application in wide world.');
insert into skills (id,stat_id,info) values ('Shadow/Track','INT','The skill of shadowing hid following people. This skill is primary used in urban or inhabited areas rather than in wilderness (where the skill of Survival incorporates tracking game in the wilds).');
...
insert into skills (id,stat_id,info) values ('Anthropology','WIS','The knowledge of human cultures, habits and customs. Unlike Streetwise (which covers only the culture and customs of the Street), or Social (which covers only what you should do in a given situation), Anthropology covers general customs and background of a culture. For example, with Streetwise, you know what alleys to avoid and what gangs are dangerous. With Social, you know the proper forms of address for a high ranking Japanese zaibatsu head. With Anthropology, you know that the customs of a N''Tanga tribesman require that a young man kill a lion in order to be accepted as an adult male.');
insert into skills (id,stat_id,info) values ('Biology','WIS','General knowledge of animals, plants, and other biological systems. At level +3, you know most types of common animals, plants. At +6, you have a general understanding of genetics, cellular biology, etc. At +10, you can perform most biolab procedures, including gene mapping and splicing.');
insert into skills (id,stat_id,info) values ('Diagnosis','WIS','The skill of clinically diagnosing symptoms and medical problems. A +3 is the equivalent of a high school nurse - you can recognize most common injuries and complaints. At +6, you would be equivalent to a trained intern; you can recognize many uncommon illnesses and know how to treat most common ones. A +9 is equivalent to you to get a diagnosis.');
insert into skills (id,stat_id,info) values ('First Aid','WIS','This skill allows the user to bind wounds, stop bleeding, and revive a stunned patients (see Trauma Team for details).');
insert into skills (id,stat_id,info) values ('Natural Medicine','WIS',null);
insert into skills (id,stat_id,info) values ('Pharmaceuticals','WIS','The skill of designing and manufacturing drugs and medicines. A minimum Chemistry skill of +4 is required. At +4, you can make aspirin. At +6, you can make hallucinogenic or antibiotics. At level +9 you can build designer drugs tailored to individual body chemistries.');
insert into skills (id,stat_id,info) values ('Surgery','WIS',null);
insert into skills (id,stat_id,info) values ('History','WIS',null);
insert into skills (id,stat_id,info) values ('Hide/Evade','WIS','The skill of losing pursuers, covering tracks and otherwise evading people on your trail. At +3, you can lose most boostergangers on the rampage. At +6, you can ditch cops and private eys. At +8, you can ditch most Solos.');
insert into skills (id,stat_id,info) values ('General Knowledge','WIS','This skill is the equivalent of a basic public school education, allowing you to know how to read, write, use basic math, and know enough history to get by. In effect, it is a "lore" or trivaia skill. A level of +1 is a basic grade school education. A skill of +2 is equal to a high school equivalency. A Knowledge Skill of +3 is equal to a college education, +4 or higher is equal to a Masters or Doctorate. At +7, you are an extremely well-educated person, and are asked to play Trival Pursuit a lot. At +9 and above, you are one of those people who knows a lot about everything (and hopefully has the good sense to keep his mouth shut).');
insert into skills (id,stat_id,info) values ('Awareness/Notice','WIS','This is equivalent of a "trained observer" skill, allowing characters to notice or be aware of clues, shadowers and other events. With an Awareness of +2 you will usually spot small pieces of paper with noted on them, doors left ajar , and obvious expressions of lying or dislike. An Awareness of +5 or better allows you to spot fairly well hidden clues, and fairly sophisticated attempts to "shadow" you. With an Awareness of +8 or greater, you routinely perform the sorts of deductive reasoning seen in the average TV cop show ("The murder was left handed because this knife has a specialized handle"). Sherlock Holmes has a +10 Awareness. Players without skill may only use their Wisdom Stat.');

insert into skills (id,stat_id,info) values ('Archery','REF','The skill required to use bows, crossbows and other arrow-based ranged weapons.');
insert into skills (id,stat_id,info) values ('Brawling','REF','The skill of fighting man to man with fist, feet and other parts of the body. Brawling is not a trained skill - it is learned on the Street by getting into a lot of fights. Unlike Martial Arts, there are no specialized attacks and no damage bonuses based on level of mastery.');
insert into skills (id,stat_id,info) values ('Dance','REF','The specific skill needed to become a professional dancer. A trained dancer +4 or greater can successfully dance for payment in small clubs or dance troupes. Dancers +6 or greater will be considered to professional caliber, and regularly give performances and have fans. Dancers +9 or greater are of "star" caliber, have a large number of fans, and may be recognized on the street.');
insert into skills (id,stat_id,info) values ('Dodge & Escape','REF','This is skill is required to dodge attacks and escape grapples and holds. If an attack is made without your knowledge, you may not apply this skill to your Defense roll.');
insert into skills (id,stat_id,info) values ('Driving','REF','This skill allows you to pilot all ground vehicles like cars, trucks, tanks and hovercraft. This skill is not usable for piloting aircraft. A skill +3 is equal to that of a very good non-professional driver. A skill of +6 allows you to drive with the skill of a moderately skilled race driver. An driver with skill of +8 or greater will be nationally ship races, and possibly have access to the most advanced ground vehicles available (as long as he makes an endorsement).');
insert into skills (id,stat_id,info) values ('Fencing','REF','The mastery of swords, rapiers and monoblades. A Fencing Skill of +3 allows you to be competent with a blade. A Skill of +5 makes you fairly skilled. A Fencing Skill of +6 might win you the National Fencing Competitions. A Skill of +8 will get you a reputation for being a true swordsman of duelist caliber. People like D''Artagnan or Miymoto Musashi have Skill of +10. They are legendary masters of the blade; the mention of whom will cause all but the stupidest young bravo to run for cover.');
insert into skills (id,stat_id,info) values ('Handgun','REF','You must have this skill to effectively use handguns of any type, including cyberware types. At +2, you ca use a handgun on a target range, through combat will still rattle you. At +5, you are as skilled as most military officers of fancy shooting you see on TV, and have begun to get a reputation of being "good with gun". A +8, you are a recognized gunslinger with a "rep". The very sound of your name makes some people back down in fear. At +10, you are a legendary gunslinger, feared by all except the stupid young punks who keep trying to "take" you in innumerable gunfight challenges.');
insert into skills (id,stat_id,info) values ('Heavy Weapons','REF','The required skill for using grenade launchers, autocannon, mortars, heavy machine guns, missiles and rocket launchers. A level +5 skill would be equivalent to a general military "Heavy Weapons" training course, giving the user the ability to use any or all of these weapon types.');
insert into skills (id,stat_id,info) values ('Boxing','REF','The manly art of fisticuffs, this form delivers lightning punches and tight blocking defense. Key attacks are: punches, blocks & parries.');
insert into skills (id,stat_id,info) values ('Wrestling','REF','This form combines techniques of Olympic and Professional wrestling. The style uses a wide variety of throws and holds to incapacitate the opponent. Key attacks include: throws, holds, escapes, chokes, sweeps, trips, and grapple.');
insert into skills (id,stat_id,info) values ('Judo','REF','This system was designed as a sport form, but is very effective in combat as well. It uses throws and sweeps to knock down the opponent. Key attacks include dodges, throws, holds, escape sweeps & trips and grappling.');
insert into skills (id,stat_id,info) values ('Aikido','REF','This form relies on using the opponent''s strength and momentum against him. It is a perfect form for stopping an opponent peacefully while making yourself very hard to hit. Key attacks are: blocks & parries, dodges, throws, holds, escapes, chokes, sweeps, trips & sweeps, grapples.');
insert into skills (id,stat_id,info) values ('Karate','REF','The Japanese version of kung fu, this style uses straight line movements and powerful blows. Variations include shotokan and kenpo, each with their own special moves. Key attacks are: punches, kicks, and blocks & parries.');
insert into skills (id,stat_id,info) values ('Tea Kwon Do','REF','A very fast and precise form, with graceful movements and some aerial kicks. Key attacks include: strikes, punches, kicks, blocks & parries, dodges.');
insert into skills (id,stat_id,info) values ('Melee','REF','The ability to use knives, axes, clubs and other hand to hand weapons in combat.');
insert into skills (id,stat_id,info) values ('Operate Heavy Machinery','REF','The required skill to operate tractors, tanks, very large trucks and construction equipment.');
insert into skills (id,stat_id,info) values ('Pilot','REF','A Piloting Skill of +1 allows you to take off and land safely in good weather conditions. A Piloting Skill of +3 or more makes you a trained pilot, able to engage in most combat situation or bad weather. Pilots with a Skill of +6 or greater are veteran pilots, able to handle themselves in almost any situation, including aerobatic maneuvers. Pilots with a Skill of +9 or greater are so good, they have a rep as pilots, and are widely known among the piloting fraternity for having the "right stuff".');
insert into skills (id,stat_id,info) values ('Rifle','REF','You must have this skill to use riffle/shotguns effectively.');
insert into skills (id,stat_id,info) values ('Stealth','REF','The skill of hiding in shadows, moving silently, evading guards, etc. A Stealth Skill of +1 is about the level of a very sneaky 10 year old stealing cookies. At +3, you are able to get past most guards, or your parents if you''ve been grounded. At +6, you are good enough to slip smoothly from shadow and not make any noise. At +8, you are the equal of most Ninja warriors. At +10, you move as silently as a shadow, making the Ninja sound like elephants.');
insert into skills (id,stat_id,info) values ('Submachinegun','REF','You must have this skill to use any type of submachine gun effectively.');
insert into skills (id,stat_id,info) values ('Pick Pocket','REF','The required skill for picking pockets without being noticed, as well as "shoplifting" small items.');

insert into skills (id,stat_id,info) values ('Basic Tech','TECH','The required skill for building or repairing simple mechanical and electrical devices, such as car engines, television sets, etc. With a Basic Tech Skill of +3, or better, you can fix minor car problems, repair basic wiring, etc. A Basic Tech Skill of +6 or better can repair stereos and TVs, rebuild an engine, etc. A Basic Tech Skill of +9 or better can build a simple computer from scratch, put together a race car engine, and maintain any kind of industrial machinery. However, they do not know enough specialized knowledge to apply it to complex things such as aircraft (just like Mr. Goodwrench) doesn''t know how to build and service an F-16).');
insert into skills (id,stat_id,info) values ('Engineering','TECH',null);
insert into skills (id,stat_id,info) values ('Demolitions','TECH','This skill allows the character to be knowledgeable in the use of explosives, as well as knowing the best explosives to use for which jobs, how to set times and detonators, and how much explosives to use to accomplish a desired result.');
insert into skills (id,stat_id,info) values ('Disguise','TECH','The skill of disguising your character to resemble someone else, whether real or fictitious. This skill incorporates elements of both makeup and acting, although it is not the same as the ability to actually be an actor.');
insert into skills (id,stat_id,info) values ('Electronics','TECH','The required skill for maintaining, repairing and modifying electronic instruments such as computers, personal electronics hardware, electronic security systems, cameras and monitors.');
insert into skills (id,stat_id,info) values ('Electronic Security','TECH','The skill of installing or countering electronic eyes, electronic locks, bugs and tracers, security cameras, pressure plates, etc. At level +3, you can jimmy or install most apartment locks and security cams. At +6, you can override most corporate office locks and traps. At +9, you can enter most high security area with impunity.');
insert into skills (id,stat_id,info) values ('Forgery','TECH','The skill of copying and creating false documents and identifications. This skill Forgery also be applied to the detection of same; if you can fake it, you can usually tell a fake as well.');
insert into skills (id,stat_id,info) values ('Film & Draw','TECH','The skill of producing professional caliber photographs or motion pictures. A skill of +2 allows you to make decent home movies. A Skill +4 or better creates work capable of winning amateur contests. A Skill of +6 or better will produce work of the level of the average Playboy cover or rock video. A photographer or cinematographer with a Skill of +8 known and probably famous. The skill of producing professional drawings. A skill of +3 allows you to produce salable "modern" art. A Skill of +6will produce artwork that is recognized end extremely pleasant to eye - as well as salable. An artist with a Skill of +8 or greater will be nationally known, have exhibitions in galleries, and have other lesser artists studying his style in art.');
insert into skills (id,stat_id,info) values ('Pick Lock','TECH','The skill required to pick locks and break into sealed containers and rooms. At +3, you can jimmy most simple locks. At +6 you can crack most safes. At +9 or better, you have a rep as master crackman, and are known to all the major players in the world.');
insert into skills (id,stat_id,info) values ('Play Instrument','TECH','The skill of knowing how to play a musical instrument. You must take this skill separately for each type of instrument played. A skill of +4 or higher will qualify your character to play professional "gigs". A Skill of +8 and above will gain musician some professional acclaim, possibly with recording contracts and command performances. At +10, you are widely acclaimed, have lots of Grammys, and regularly jam with Kerry Eurodyne.');
insert into skills (id,stat_id,info) values ('Weaponsmith','TECH','The required skill for repairing and maintaining weapons of all types. At level +2, you can do repairs and field stripping. At level +6, you can repair all types of weapons and make simple modifications. At level +8. You can design your own weapons to order.');
...
insert into weapons (name,type,subtype,accuracy,concealability,availability,damage,ammo,shots,rof,reliability,range,cost, info) values ('Sternmeyer Type 35','P','H',0,'J','C','3D6','11mm',8,2,'VR','50m',400,'Rugged, reliable, with excellent stopping power. Another fine E.C.C. product from the United Germanies.');
insert into weapons (name,type,subtype,accuracy,concealability,availability,damage,ammo,shots,rof,reliability,range,cost, info) values ('Armalite 44','P','VH',0,'J','E','4D6+1','12mm',8,1,'ST','50m',450,'Designed as an alternate to the 1998 U.S. Army sidearm trials. A solid contender.');
